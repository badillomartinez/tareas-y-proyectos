...
\begin{pmatrix} x \\ y \end{pmatrix}\in\overline{B_1}\right\}$

$S_{\infty}=\left\{
A\begin{pmatrix} x \\ y \end{pmatrix}:
\begin{pmatrix} x \\ y \end{pmatrix}\in\overline{B_{\infty}}\right\}$

$S_2 =\left\{A\begin{pmatrix} x \\ y \end{pmatrix}:
\begin{pmatrix} x \\ y \end{pmatrix}\in C\right\}$
